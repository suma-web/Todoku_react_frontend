...
- 管理者向けユーザーRole・有効状態、アカウント削除、所属、質問カテゴリ管理
...
| `/questions/new` | 全Role | 公開質問・非公開相談の作成 |
...
2026年9月10日時点で、認証API、Role別ルート、添付入力制限、アカウント削除APIの15テストが全件成功しています。重点対象3モジュールのステートメントカバレッジは92%です。
